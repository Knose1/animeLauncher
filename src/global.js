...
{
	return removeDiacritics(fileName.replace(/\\|\/|:|\*|\?|"|\<|\>|\|/g, replacer))
}
global.toFileName = toFileName;

/**
 * From {@link https://stackoverflow.com/questions/18123501/replacing-accented-characters-with-plain-ascii-ones}
 * @param {*} str 
 */
